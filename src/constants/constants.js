...
export const SEARCH_USER1 = 'SEARCH_USER1';
...
export const SEARCH_USER1_SUCCESS = 'SEARCH_USER1_SUCCESS';

export const GET_PRODUCTS_SUCCESS = 'GET_PRODUCTS_SUCCESS';
export const GET_SETTINGS_SUCCESS = 'GET_SETTINGS_SUCCESS';
export const GET_MENUS_SUCCESS = 'GET_MENUS_SUCCESS';
export const GET_POSTS_SUCCESS = 'GET_POSTS_SUCCESS';
export const GET_USERS1_SUCCESS = 'GET_USER1_SUCCESS';
...
export const ADD_USER1_SUCCESS = 'ADD_USER_SUCCESS';

export const REMOVE_PRODUCT = 'REMOVE_PRODUCT';
export const REMOVE_SETTINGS = 'REMOVE_SETTINGS';
export const REMOVE_MENU = 'REMOVE_MENU';
export const REMOVE_POST = 'REMOVE_POST';
export const REMOVE_USER1 = 'REMOVE_USER1';

export const REMOVE_PRODUCT_SUCCESS = 'REMOVE_PRODUCT_SUCCESS';
export const REMOVE_SETTINGS_SUCCESS = 'REMOVE_SETTINGS_SUCCESS';
export const REMOVE_MENU_SUCCESS = 'REMOVE_MENU_SUCCESS';
export const REMOVE_POST_SUCCESS = 'REMOVE_POST_SUCCESS';
export const REMOVE_USER1_SUCCESS = 'REMOVE_USER1_SUCCESS';
