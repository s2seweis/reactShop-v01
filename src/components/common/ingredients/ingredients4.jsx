...
const ingredients4 = (option, option1, selectedSize, selectedColor, id, isItemOnBasket, addToBasket) => {
  ...
  const toppings2 = ingredients?.parameters4?.map((person) => ({ name: person.name, price: person.price })) || []
