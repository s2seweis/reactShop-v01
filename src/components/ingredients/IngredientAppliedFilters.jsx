...
const IngredientAppliedFilters = ({ filteredIngredientsCount }) => {
    ...
    <>
      <div className="product-list-header">
        <div className="product-list-header-title">
          <h5>
            {filteredIngredientsCount > 0
              && `Found ${filteredIngredientsCount} ${filteredIngredientsCount > 1 ? 'ingredients' : 'ingredient'}`}
          </h5>
        </div>
      </div>
...
IngredientAppliedFilters.defaultProps = {
  filteredIngredientsCount: 0
};

IngredientAppliedFilters.propTypes = {
  filteredIngredientsCount: PropType.number
};

export default IngredientAppliedFilters;
